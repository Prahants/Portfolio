...
export default function DotGrid() {
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            const mask = `radial-gradient(circle 300px at ${x}px ${y}px, black 0%, black 40%, transparent 100%)`;
        ...
        <>
            ...
            <div
                ...
                style={{
                    zIndex: 1,
                    backgroundImage:
                        "radial-gradient(circle, rgba(255, 255, 255, 0.1) 0.35px, transparent 0.4px)",
                    backgroundSize: "30px 30px",
            ...
            <div
                ...
                style={{
                    zIndex: 1,
                    backgroundImage:
                        "radial-gradient(circle, rgba(255, 255, 255, 0.39) 0.5px, transparent 1px)",
                    backgroundSize: "30px 30px",
                    backgroundPosition: "30px 30px",
